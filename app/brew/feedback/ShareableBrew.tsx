        ...
        <CardContent>
          ...
          <Stack direction="row" spacing={3} flexWrap="wrap">
            <Box display="flex" alignItems="center" gap={0.5}>
              ...
              <Typography
                variant="body2"
                sx={{ fontWeight: 500, color: '#654321' }}
              >
                {brewData.dose}g
              </Typography>
            </Box>
            ...
            {brewTime !== undefined && brewTime > 0 && (
              <Box display="flex" alignItems="center" gap={0.5}>
                ...
                <Typography
                  ...
                  sx={{ fontWeight: 500, color: '#654321' }}
                >
                  {String(Math.floor(brewTime / 60)).padStart(2, '0')}:
                  {String(brewTime % 60).padStart(2, '0')}
                </Typography>
              </Box>
            )}
          </Stack>
        ...
        <CardContent>
          ...
          <Box mb={3}>
            ...
            <Rating
              ...
              onChange={(_, value) =>
                setFeedback(prev => ({ ...prev, overall_rating: value || 0 }))
              }
            />
          </Box>
