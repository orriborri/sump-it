    ...
    switch (form.currentStep) {
        ...
        return (
          <Box>
            <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
              Choose your coffee beans, brewing method, and grinder to get started.
            </Typography>
            <BeanSelector
              form={form}
              beans={beans}
      ...
      case 1:
        return (
          <Box>
            <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
              Set your complete brewing recipe including recommendations, grind setting, water and coffee dose.
            </Typography>
            <ComprehensiveRecipe
