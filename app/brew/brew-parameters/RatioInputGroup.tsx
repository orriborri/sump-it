...
export const RatioInputGroup = ({
  ...
  const getRatioDescription = (
    ...
    if (ratio >= 15 && ratio <= 18)
      return { text: 'Balanced', color: 'success' }
  ...
  }, [isRatioLocked, waterValue, doseValue, setValue])
    ...
    <Box sx={{ mb: 3 }}>
      ...
      <Paper elevation={1} sx={{ p: 2, mb: 3 }}>
        ...
        <Box sx={{ mt: 3, mb: 1 }}>
          ...
          >
            <Typography variant="subtitle1">Coffee-to-Water Ratio</Typography>

            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Tooltip
                title={
                  isRatioLocked
                    ? 'Ratio is locked. Changing water or coffee will maintain this ratio'
                    : 'Ratio will change based on water and coffee values'
                }
              >
                <IconButton
                ...
                <Slider
                  ...
                  onChange={(_, value) => {
                    ...
                    if (doseValue && isRatioLocked) {
                      setValue(
                        'water',
                        Math.round(doseValue * (value as number))
                      )
                    }
                  }}
        ...
        {doseValue > 0 && waterValue > 0 && (
          <Typography
            ...
            sx={{ mt: 2 }}
          >
            {doseValue}g of coffee with {waterValue}ml of water = 1:
            {(waterValue / doseValue).toFixed(1)} ratio
          </Typography>
        )}
      </Paper>
    </Box>
