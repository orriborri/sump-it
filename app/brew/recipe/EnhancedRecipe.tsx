      ...
      {suggestion && (
        ...
        >
          ...
          <Typography variant="body2" sx={{ mb: 1 }}>
            Water: {suggestion.water}ml • Coffee: {suggestion.dose}g • 
            Ratio: 1:{suggestion.ratio} • Grind: {suggestion.grind}
          </Typography>
      ...
      {loaded && previousBrews.length === 0 ? (
        <Box>
          ...
          <Typography variant="body2">
            ...
            {suggestion && " We've provided default parameters above to get you started."}
          </Typography>
        </Box>
      ) : (
        <Box>
